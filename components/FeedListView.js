...
function generateRows({repos, events}) {
  console.log('generateRows', repos, events)
            ...
            return (
              <View key={event.id} style={styles.listItem}>
                ...
                <View style={styles.text}>
                  ...
                  {repo && repo.description && <Text style={styles.description}>{repo && repo.description}</Text>}
                  {repo && <Text style={styles.stats}>{repo.subscribers_count} 👀 {repo.stargazers_count} ⭐ {repo.forks_count} 🍴</Text>}
                </View>
              </View>
            );
          }}
